...
mat3x2!(sub_impl);
mat3x2!(sub_assign_impl);
mat3x2!(mul_impl);
mat3x2!(mul_assign_impl);
mat3x2!(div_impl);
mat3x2!(div_assign_impl);
...
mod tests {
    ...
    mat3x2_data!(sub_assign_test);
    mat3x2_data!(mul_test);
    mat3x2_data!(mul_assign_test);
    mat3x2_data!(div_test);
    mat3x2_data!(div_assign_test);
}
